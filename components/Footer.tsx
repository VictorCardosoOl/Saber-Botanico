  ...
  return (
    <footer className="relative bg-premium-black text-stone-400 overflow-hidden font-sans selection:bg-stone-700 selection:text-white border-t border-white/5">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
          {/* Blob Dourado Suave - Otimizado com will-change */}
          <div className="absolute top-0 right-1/4 w-[50vw] h-[50vw] bg-gold/5 rounded-full blur-[120px] mix-blend-screen opacity-20 animate-pulse-subtle will-change-transform"></div>
          {/* Blob Floresta Profunda */}
          <div className="absolute bottom-0 left-1/4 w-[60vw] h-[60vw] bg-forest-light/10 rounded-full blur-[150px] mix-blend-screen opacity-30 will-change-transform"></div>
      </div>
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full text-center pointer-events-none select-none z-0 leading-none">
        {/* Aplicação da classe 'liquid-filter' otimizada */}
      ...
      {/* Reduzi o backdrop-blur de 40px para 20px para melhor performance */}
      <div className="relative z-10 backdrop-blur-[20px] bg-premium-black/40">
        
        {/* Inline Liquid Noise Texture - ULTRA OPTIMIZED */}
        {/* numOctaves reduzido de 4 para 1. baseFrequency ajustado para manter textura visual. */}
