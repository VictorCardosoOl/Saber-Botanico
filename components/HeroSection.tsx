        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-12 gap-12 lg:gap-8 items-center h-full">
          ...
          <div className="flex flex-col gap-10 lg:col-span-6 xl:col-span-5 z-10 animate-fade-in-up">
            <div className="flex flex-col gap-4 text-left">
              ...
              <h1 className="text-white text-fluid-h1 font-serif font-light tracking-[-0.01em]">
                Cultivando <br/>
            ...
            <div className="mt-8 lg:mt-12 pt-8 border-t border-white/5">
              ...
              <div className="flex flex-wrap items-center gap-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                ...
                <span className="font-sans text-lg font-bold tracking-widest text-white">ELLE</span>
          ...
          <div className="relative w-full lg:col-span-6 lg:col-start-7 xl:col-start-7 flex justify-center lg:justify-end group perspective-1000">
            <div className="relative w-full max-w-[500px] lg:max-w-full aspect-[4/5]">
               <div className="absolute inset-0 border border-gold/20 rounded-t-[10rem] rounded-b-xl translate-x-3 translate-y-3 z-0"></div>
               <div className="relative z-10 w-full h-full overflow-hidden rounded-t-[10rem] rounded-b-xl shadow-2xl shadow-black/80 border border-white/5 bg-forest-dark">
                  <div 
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 glass-panel border-t border-white/10">
                    <div className="flex items-end justify-between">
                      ...
                      <button className="size-10 md:size-12 rounded-full border border-gold/50 text-gold hover:bg-gold hover:text-forest-dark transition-all flex items-center justify-center shrink-0">
