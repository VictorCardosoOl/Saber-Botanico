        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-24 relative items-center">
          ...
          <div className="lg:col-span-7 relative mt-16 lg:mt-0">
             <div className="grid grid-cols-12 grid-rows-12 aspect-[4/5] md:aspect-square lg:aspect-[4/3] w-full">
                ...
                <div className="col-start-4 col-span-9 row-start-1 row-span-10 z-10 bg-ink p-1 shadow-2xl transform rotate-1 transition-transform hover:rotate-0 duration-1000 ease-out group cursor-pointer" onClick={() => window.open(SOIL_IMAGE_MAIN, '_blank')}>
                ...
                {/* Overlay Image 1 */}
                <div className="col-start-2 col-span-5 row-start-7 row-span-6 z-20 shadow-xl border-[6px] border-paper transform -rotate-2 group transition-transform hover:rotate-0 duration-700 ease-out cursor-pointer" onClick={() => window.open(SOIL_IMAGE_SMALL_1, '_blank')}>
                ...
                <div className="col-start-1 col-span-3 row-start-2 row-span-3 z-30 shadow-lg border border-gold/30 bg-paper p-1 rotate-3 hover:rotate-0 transition-transform duration-500 cursor-pointer" onClick={() => window.open(SOIL_IMAGE_SMALL_2, '_blank')}>
